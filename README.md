...
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-chrome:3.0.0-beta2
```
...
``` bash
$ docker run -d -p 4444:4444 selenium/standalone-chrome:3.0.0-beta2
# OR
$ docker run -d -p 4444:4444 selenium/standalone-firefox:3.0.0-beta2
```
...
``` bash
$ docker run -d -p 4444:4444 --name selenium-hub selenium/hub:3.0.0-beta2
```

### Chrome and Firefox Grid Nodes

``` bash
$ docker run -d --link selenium-hub:hub selenium/node-chrome:3.0.0-beta2
$ docker run -d --link selenium-hub:hub selenium/node-firefox:3.0.0-beta2
```
...
``` bash
$ docker run -d -p 4444:4444 -e JAVA_OPTS=-Xmx512m --name selenium-hub selenium/hub:3.0.0-beta2
```
...
``` bash
$ docker run -d -p 4444:4444 -e SE_OPTS=-debug --name selenium-hub selenium/hub:3.0.0-beta2
```
...
``` bash
$ docker run -d --name selenium-hub -p 4444:4444 selenium/hub:3.0.0-beta2
$ CH=$(docker run --rm --name=ch \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    selenium/node-chrome:3.0.0-beta2)
```
...
$ FF=$(docker run --rm --name=fx \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    selenium/node-firefox:3.0.0-beta2)
```
...
``` bash
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-chrome-debug:3.0.0-beta2
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-firefox-debug:3.0.0-beta2
```
e.g.:
``` bash
$ docker run -d -P -p 5900:5900 --link selenium-hub:hub selenium/node-chrome-debug:3.0.0-beta2
$ docker run -d -P -p 5901:5900 --link selenium-hub:hub selenium/node-firefox-debug:3.0.0-beta2
```
...
And for standalone: 
``` bash
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-chrome-debug:3.0.0-beta2
# OR
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-firefox-debug:3.0.0-beta2
```
or
``` bash
$ docker run -d -p 4444:4444 -p 5900:5900 selenium/standalone-chrome-debug:3.0.0-beta2
# OR
$ docker run -d -p 4444:4444 -p 5901:5900 selenium/standalone-firefox-debug:3.0.0-beta2
```
...
``` dockerfile
#FROM selenium/node-chrome-debug:3.0.0-beta2
#FROM selenium/node-firefox-debug:3.0.0-beta2
...
selenium/node-firefox           3.0.0-beta2              69f762d0d79e        29 minutes ago      552.1 MB
selenium/node-chrome            3.0.0-beta2              9dd73160660b        30 minutes ago      723.6 MB
selenium/node-base              3.0.0-beta2              1b7a0b7024b1        32 minutes ago      426.1 MB
selenium/hub                    3.0.0-beta2              2570bbb98229        33 minutes ago      394.4 MB
selenium/base                   3.0.0-beta2              33478d455dab        33 minutes ago      362.6 MB
